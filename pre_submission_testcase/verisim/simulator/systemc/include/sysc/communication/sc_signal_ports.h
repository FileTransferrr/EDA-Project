...
//  CLASS : sc_in_base<T>
//
//  The sc_signal<T> input port base class.
// ----------------------------------------------------------------------------
...
public:
    ...
    typedef sc_in_base<data_type>                         this_type;
...
public:
    ...
    explicit sc_in_base( const char* name_ )
	: base_type( name_ ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}

    explicit sc_in_base( const in_if_type& interface_ )
        : base_type( const_cast<in_if_type&>( interface_ ) ), m_traces( 0 ),
	  m_change_finder_p(0)
        {}

    sc_in_base( const char* name_, const in_if_type& interface_ )
	: base_type( name_, const_cast<in_if_type&>( interface_ ) ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}

    explicit sc_in_base( in_port_type& parent_ )
	: base_type( parent_ ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}

    sc_in_base( const char* name_, in_port_type& parent_ )
	: base_type( name_, parent_ ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}

    explicit sc_in_base( inout_port_type& parent_ )
	: base_type(), m_traces( 0 ),
	  m_change_finder_p(0)
	{ sc_port_base::bind( parent_ ); }

    sc_in_base( const char* name_, inout_port_type& parent_ )
	: base_type( name_ ), m_traces( 0 ),
	  m_change_finder_p(0)
	{ sc_port_base::bind( parent_ ); }

    sc_in_base( this_type& parent_ )
	: base_type( parent_ ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}

    sc_in_base( const char* name_, this_type& parent_ )
	: base_type( name_, parent_ ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}
    ...
    sc_port_direction direction() const final
    { return SC_DIRECTION_IN; }

    void report_signal_type(std::ostream& out) final
    { 
        sc_report_signal_type(out, *this);
     }
...
template<typename T>
::std::ostream& operator << ( ::std::ostream& os, const sc_in_base<T>& a )
{
    return os << a->read();
}
...
inline
void
sc_in_base<T>::end_of_elaboration()
{
    if( m_traces != 0 ) {
...
inline
void
sc_in_base<T>::add_trace_internal( sc_trace_file* tf_, const std::string& name_ )
const
{
    if( tf_ != 0 ) {
	if( m_traces == 0 ) {
...
inline
void
sc_in_base<T>::add_trace( sc_trace_file* tf_, const std::string& name_ )
const
{
...
inline
void
sc_in_base<T>::remove_traces() const
{
    if( m_traces != 0 ) {
...
inline
int
sc_in_base<T>::vbind( sc_interface& interface_ )
{
...
inline
int
sc_in_base<T>::vbind( sc_port_base& parent_ )
{
...
public:
    ...
    typedef sc_in_base<data_type>               base_type;
    ...
    explicit sc_in( const char* name_ ) : base_type( name_ )
    {}
...
template <>
class SC_API sc_in<bool> : public sc_in_base<bool>
{
public:

    // typedefs
    typedef sc_in<data_type>                        this_type;
    typedef sc_in_base<bool>                        base_type;
...
public:
    ...
    sc_in()
	: base_type(), m_neg_finder_p(0), m_pos_finder_p(0)
	{}

    explicit sc_in( const char* name_ )
	: base_type( name_ ), m_neg_finder_p(0), m_pos_finder_p(0)
	{}
    ...
    explicit sc_in( in_port_type& parent_ )
	: base_type( parent_ ), m_neg_finder_p(0), m_pos_finder_p(0)
	{}

    sc_in( const char* name_, in_port_type& parent_ )
	: base_type( name_, parent_ ), m_neg_finder_p(0), m_pos_finder_p(0)
	{}
...
template <>
class SC_API sc_in<sc_dt::sc_logic> : public sc_in_base<sc_dt::sc_logic>
{
public:

    // typedefs
    typedef sc_in<data_type>                              this_type;
    typedef sc_in_base<sc_dt::sc_logic>                   base_type;
...
public:
    ...
    explicit sc_in( const in_if_type& interface_ )
	: base_type( interface_ ), m_neg_finder_p(0), m_pos_finder_p(0)
	{}

    sc_in( const char* name_, const in_if_type& interface_ )
	: base_type( name_, interface_ ), m_neg_finder_p(0), m_pos_finder_p(0)
	{}
...
public:
    ...
    typedef sc_port<if_type,1,SC_ONE_OR_MORE_BOUND>    base_type;
    typedef sc_inout_base<data_type>                   this_type;
...
public:
    ...
    explicit sc_inout_base( const char* name_ )
	: base_type( name_ ), m_init_val( 0 ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}

    explicit sc_inout_base( inout_if_type& interface_ )
	: base_type( interface_ ), m_init_val( 0 ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}

    sc_inout_base( const char* name_, inout_if_type& interface_ )
	: base_type( name_, interface_ ), m_init_val( 0 ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}

    explicit sc_inout_base( inout_port_type& parent_ )
	: base_type( parent_ ), m_init_val( 0 ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}

    sc_inout_base( const char* name_, inout_port_type& parent_ )
	: base_type( name_, parent_ ), m_init_val( 0 ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}

    sc_inout_base( this_type& parent_ )
	: base_type( parent_ ), m_init_val( 0 ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}

    sc_inout_base( const char* name_, this_type& parent_ )
	: base_type( name_, parent_ ), m_init_val( 0 ), m_traces( 0 ),
	  m_change_finder_p(0)
	{}
    ...
    sc_port_direction direction() const override
    { return SC_DIRECTION_INOUT; }
...
template<typename T>
::std::ostream& operator << ( ::std::ostream& os, const sc_inout_base<T>& a )
{
    return os << a->read();
}
...
inline
void
sc_inout_base<T>::initialize( const data_type& value_ )
{
...
inline
void
sc_inout_base<T>::end_of_elaboration()
{
    if( m_init_val != 0 ) {
	write( *m_init_val );
	delete m_init_val;
...
inline
void
sc_inout_base<T>::add_trace_internal( sc_trace_file* tf_, const std::string& name_)
const
{
    if( tf_ != 0 ) {
	    if( m_traces == 0 ) {
...
inline
void
sc_inout_base<T>::add_trace( sc_trace_file* tf_, const std::string& name_) const
{
    sc_deprecated_add_trace();
    add_trace_internal(tf_, name_);
}
...
inline
void
sc_inout_base<T>::remove_traces() const
{
    if( m_traces != 0 ) {
...
template <class T>
class SC_API sc_inout :
    public sc_inout_base<T>
{
public:
    typedef T                                   data_type;

    typedef sc_inout_base<data_type>               base_type;
    ...
    sc_inout( const this_type& ) = delete;
};
...
class SC_API sc_inout<bool> :
    public sc_inout_base<bool>
{
public:

    // typedefs
    typedef sc_inout<bool>                                  this_type;
    typedef sc_inout_base<bool>                             base_type;
...
: public sc_inout_base<sc_dt::sc_logic>
{
public:

    // typedefs

    typedef sc_inout<sc_dt::sc_logic>                       this_type;
    typedef sc_inout_base<sc_dt::sc_logic>                  base_type;
