...
SC_DEFINE_MESSAGE(SC_ID_DPI_FUNC_WAIT_N_NOT_ALLOWED_ , 575,
	"wait(n) with an integer argument cannot be called from DPI import function" )
SC_DEFINE_MESSAGE(SC_ID_STATIC_PROCESS_RUN_FUNC_IN_THREAD_NOT_ALLOWED_ , 576,
	"run function in thread as a static process is not supported" )
